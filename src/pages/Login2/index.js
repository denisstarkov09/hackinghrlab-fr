...
const Login = ({
  ...
  }, [history, logout, updateUserPopUp]);
        ...
        if (history != null) {
          ...
          if (updatedEvent.ticket === "premium") {
            if (!isEmpty(userProfile) && userProfile.memberShip === "premium") {
              ...
              if (onClose && (window.location.pathname.substring(0, 15) !== INTERNAL_LINKS.CREATORS || window.location.pathname.substring(0, 15) !== INTERNAL_LINKS.LANDING_PAGUE)) {
                onClose();
              }
            } else {
  ...
  return (
    <div className="login-page-2">
      ...
      <div className="login-dialog">
        ...
        >
          {(window.location.pathname !== INTERNAL_LINKS.LOGIN) && (
            <div className="container-icon-close">
              <img className="icon-close" onClick={() => { modal(false) }} src={IconPlus} alt="icon-close" />
            </div>
          )}
